...
reg   [0:0] exitcond_i_i_reg_251;
reg   [9:0] indvar_i_i_reg_133;
reg   [9:0] indvar_i_i_reg_133_pp0_iter1_reg;
wire    ap_block_state9_pp0_stage0_iter0;
reg    ap_block_state10_pp0_stage0_iter1;
wire    ap_block_state11_pp0_stage0_iter2;
reg    ap_block_pp0_stage0_11001;
wire   [10:0] tmp_fu_145_p1;
reg   [10:0] tmp_reg_225;
reg    ap_block_state1;
wire   [29:0] sum_i_fu_167_p2;
reg   [29:0] sum_i_reg_230;
reg    ap_sig_ioackin_m_axi_tx_buffer_V_ARREADY;
wire    ap_CS_fsm_state8;
wire   [0:0] exitcond_i_i_fu_183_p2;
reg   [0:0] exitcond_i_i_reg_251_pp0_iter1_reg;
wire   [9:0] indvar_next_i_i_fu_189_p2;
reg   [9:0] indvar_next_i_i_reg_255;
reg    ap_enable_reg_pp0_iter0;
reg   [63:0] tx_buffer_V_addr_rea_reg_260;
reg    ap_block_pp0_stage0_subdone;
reg    ap_condition_pp0_exit_iter0_state9;
reg    ap_enable_reg_pp0_iter2;
reg   [9:0] ap_phi_mux_indvar_i_i_phi_fu_137_p4;
wire   [63:0] indvar4_i_i_fu_195_p1;
wire   [63:0] sum_cast_i_fu_173_p1;
reg    ap_reg_ioackin_m_axi_tx_buffer_V_ARREADY;
wire   [20:0] tmp_7_i_fu_149_p4;
wire   [29:0] tmp_8_cast_i_fu_159_p1;
wire   [29:0] sext_cast_i_fu_163_p1;
wire    ap_CS_fsm_state12;
wire   [12:0] lhs_V_cast_i_i_fu_200_p1;
wire   [12:0] tmp_2_cast_i_i_fu_209_p1;
wire   [12:0] r_V_fu_203_p2;
wire   [0:0] tmp_3_i_i_fu_212_p2;
wire   [12:0] data_length_V_write_s_fu_218_p3;
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_i_reg_251 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        indvar_i_i_reg_133 <= indvar_next_i_i_reg_255;
    end else if ((1'b1 == ap_CS_fsm_state8)) begin
        indvar_i_i_reg_133 <= 10'd0;
    end
end
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_i_reg_251 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tx_buffer_V_addr_rea_reg_260 <= m_axi_tx_buffer_V_RDATA;
    end
end

always @ (*) begin
    if ((exitcond_i_i_fu_183_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((exitcond_i_i_reg_251 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0))) begin
...
always @ (*) begin
    if (((exitcond_i_i_reg_251_pp0_iter1_reg == 1'd0) & (ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        cache_V_we0 = 1'b1;
    end else begin
        cache_V_we0 = 1'b0;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if ((~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_i_i_fu_183_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)) & ~((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if ((((ap_enable_reg_pp0_iter2 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (ap_enable_reg_pp0_iter1 == 1'b0)) | ((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_i_i_fu_183_p2 == 1'd1) & (ap_enable_reg_pp0_iter1 == 1'b0)))) begin
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((exitcond_i_i_reg_251 == 1'd0) & (m_axi_tx_buffer_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((exitcond_i_i_reg_251 == 1'd0) & (m_axi_tx_buffer_V_RVALID == 1'b0) & (ap_enable_reg_pp0_iter1 == 1'b1));
end
...
always @ (*) begin
    ap_block_state10_pp0_stage0_iter1 = ((exitcond_i_i_reg_251 == 1'd0) & (m_axi_tx_buffer_V_RVALID == 1'b0));
end
...
assign cache_V_address0 = indvar4_i_i_fu_195_p1;

assign cache_V_d0 = tx_buffer_V_addr_rea_reg_260;

assign data_length_V_write_s_fu_218_p3 = ((tmp_3_i_i_fu_212_p2[0:0] === 1'b1) ? final_burst_length_V : 13'd4096);

assign exitcond_i_i_fu_183_p2 = ((ap_phi_mux_indvar_i_i_phi_fu_137_p4 == 10'd512) ? 1'b1 : 1'b0);

assign indvar4_i_i_fu_195_p1 = indvar_i_i_reg_133_pp0_iter1_reg;

assign indvar_next_i_i_fu_189_p2 = (ap_phi_mux_indvar_i_i_phi_fu_137_p4 + 10'd1);

assign lhs_V_cast_i_i_fu_200_p1 = loop_count_V;

assign m_axi_tx_buffer_V_ARADDR = sum_cast_i_fu_173_p1;
...
assign r_V_fu_203_p2 = ($signed(lhs_V_cast_i_i_fu_200_p1) + $signed(13'd8191));

assign sext_cast_i_fu_163_p1 = tx_buffer_V_offset;

assign sum_cast_i_fu_173_p1 = sum_i_reg_230;

assign sum_i_fu_167_p2 = (tmp_8_cast_i_fu_159_p1 + sext_cast_i_fu_163_p1);

assign tmp_2_cast_i_i_fu_209_p1 = tmp_reg_225;

assign tmp_3_i_i_fu_212_p2 = ((tmp_2_cast_i_i_fu_209_p1 == r_V_fu_203_p2) ? 1'b1 : 1'b0);

assign tmp_7_i_fu_149_p4 = {{{tx_buffer_V_offset1}, {tmp_fu_145_p1}}, {9'd0}};

assign tmp_8_cast_i_fu_159_p1 = tmp_7_i_fu_149_p4;

assign tmp_fu_145_p1 = val_assign[10:0];
