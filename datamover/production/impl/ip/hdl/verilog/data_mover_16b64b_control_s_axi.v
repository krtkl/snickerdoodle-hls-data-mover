...
`timescale 1ns/1ps
module data_mover_16b64b_control_s_axi
#(parameter
    ...
    output wire [22:0]                   tx_buffer_length_V,
    output wire [31:0]                   rx_buffer_V,
    output wire [22:0]                   rx_buffer_length_V,
...
//------------------------Local signal-------------------
    ...
    reg  [22:0]                   int_tx_buffer_length_V = 'b0;
    reg  [31:0]                   int_rx_buffer_V = 'b0;
    reg  [22:0]                   int_rx_buffer_length_V = 'b0;
...
assign tx_buffer_V        = int_tx_buffer_V;
...
// int_tx_buffer_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tx_buffer_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TX_BUFFER_V_DATA_0)
            int_tx_buffer_V[31:0] <= (WDATA[31:0] & wmask) | (int_tx_buffer_V[31:0] & ~wmask);
    end
end

// int_tx_buffer_length_V[22:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_tx_buffer_length_V[22:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_TX_BUFFER_LENGTH_V_DATA_0)
            int_tx_buffer_length_V[22:0] <= (WDATA[31:0] & wmask) | (int_tx_buffer_length_V[22:0] & ~wmask);
    end
end

// int_rx_buffer_V[31:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_rx_buffer_V[31:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_RX_BUFFER_V_DATA_0)
            int_rx_buffer_V[31:0] <= (WDATA[31:0] & wmask) | (int_rx_buffer_V[31:0] & ~wmask);
    end
end

// int_rx_buffer_length_V[22:0]
always @(posedge ACLK) begin
    if (ARESET)
        int_rx_buffer_length_V[22:0] <= 0;
    else if (ACLK_EN) begin
        if (w_hs && waddr == ADDR_RX_BUFFER_LENGTH_V_DATA_0)
            int_rx_buffer_length_V[22:0] <= (WDATA[31:0] & wmask) | (int_rx_buffer_length_V[22:0] & ~wmask);
    end
end
