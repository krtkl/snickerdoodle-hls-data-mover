...
architecture behav of dataflow_in_loop is 
    ...
    signal rx_axis_words25_U0_ap_start : STD_LOGIC;
    signal rx_axis_words25_U0_ap_done : STD_LOGIC;
    signal rx_axis_words25_U0_ap_continue : STD_LOGIC;
    signal rx_axis_words25_U0_ap_idle : STD_LOGIC;
    signal rx_axis_words25_U0_ap_ready : STD_LOGIC;
    signal rx_axis_words25_U0_axis_V_V_TREADY : STD_LOGIC;
    signal rx_axis_words25_U0_cache_V_address0 : STD_LOGIC_VECTOR (8 downto 0);
    signal rx_axis_words25_U0_cache_V_ce0 : STD_LOGIC;
    signal rx_axis_words25_U0_cache_V_we0 : STD_LOGIC;
    ...
    signal rx_axis_words25_U0_cache_V_full_n : STD_LOGIC;
    ...
    signal rx_axis_words25_U0_start_full_n : STD_LOGIC;
    signal rx_axis_words25_U0_start_write : STD_LOGIC;
    signal write_burst_U0_start_full_n : STD_LOGIC;
    signal write_burst_U0_start_write : STD_LOGIC;

    component rx_axis_words25 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        ap_start : IN STD_LOGIC;
...
begin
    ...
    rx_axis_words25_U0 : component rx_axis_words25
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    rx_buffer_V_offset_c_U : component fifo_w29_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
    ...
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if (((rx_axis_words25_U0_ap_done and rx_axis_words25_U0_ap_continue) = ap_const_logic_1)) then 
                    ap_sync_reg_channel_write_buffer_offset_V <= ap_const_logic_0;
                else 
    ...
    ap_channel_done_buffer_offset_V <= (rx_axis_words25_U0_ap_done and (ap_sync_reg_channel_write_buffer_offset_V xor ap_const_logic_1));
    ap_channel_done_cache_V <= (rx_axis_words25_U0_ap_done and (ap_sync_reg_channel_write_cache_V xor ap_const_logic_1));
    ap_done <= write_burst_U0_ap_done;
    ap_idle <= (write_burst_U0_ap_idle and rx_axis_words25_U0_ap_idle and (buffer_offset_V_empty_n xor ap_const_logic_1) and (cache_V_t_empty_n xor ap_const_logic_1));
    ap_ready <= rx_axis_words25_U0_ap_ready;
    ...
    ap_sync_channel_write_cache_V <= ((rx_axis_words25_U0_cache_V_full_n and ap_channel_done_cache_V) or ap_sync_reg_channel_write_cache_V);
    ap_sync_continue <= ap_continue;
    ap_sync_done <= write_burst_U0_ap_done;
    ap_sync_ready <= rx_axis_words25_U0_ap_ready;
    axis_V_V_TREADY <= rx_axis_words25_U0_axis_V_V_TREADY;
    ...
    m_axi_rx_buffer_V_WUSER <= write_burst_U0_m_axi_rx_buffer_V_WUSER;
    m_axi_rx_buffer_V_WVALID <= write_burst_U0_m_axi_rx_buffer_V_WVALID;
    rx_axis_words25_U0_ap_continue <= (ap_sync_channel_write_cache_V and ap_sync_channel_write_buffer_offset_V);
    rx_axis_words25_U0_ap_start <= ap_start;
    rx_axis_words25_U0_cache_V_full_n <= cache_V_i_full_n;
