...
architecture behav of read_burst is 
    ...
    signal exitcond_i_i_reg_238 : STD_LOGIC_VECTOR (0 downto 0);
    signal indvar_i_i_reg_122 : STD_LOGIC_VECTOR (9 downto 0);
    signal indvar_i_i_reg_122_pp0_iter1_reg : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_state9_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state10_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state11_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal tmp_fu_134_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_reg_212 : STD_LOGIC_VECTOR (12 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal sum_i_fu_154_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal sum_i_reg_217 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_sig_ioackin_m_axi_tx_buffer_V_ARREADY : STD_LOGIC;
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal exitcond_i_i_fu_170_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_i_i_reg_238_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal indvar_next_i_i_fu_176_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal indvar_next_i_i_reg_242 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal tx_buffer_V_addr_rea_reg_247 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state9 : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal ap_phi_mux_indvar_i_i_phi_fu_126_p4 : STD_LOGIC_VECTOR (9 downto 0);
    signal indvar1_i_i_fu_182_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum_cast_i_fu_160_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_reg_ioackin_m_axi_tx_buffer_V_ARREADY : STD_LOGIC := '0';
    signal buffer_offset_V_fu_138_p3 : STD_LOGIC_VECTOR (21 downto 0);
    signal sext_cast_i_fu_150_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal tmp_i_cast_i_fu_146_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_CS_fsm_state12 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state12 : signal is "none";
    signal lhs_V_cast_i_i_fu_187_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_2_cast_i_i_fu_196_p1 : STD_LOGIC_VECTOR (14 downto 0);
    signal r_V_fu_190_p2 : STD_LOGIC_VECTOR (14 downto 0);
    signal tmp_3_i_i_fu_199_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal data_length_V_write_s_fu_205_p3 : STD_LOGIC_VECTOR (10 downto 0);
...
begin
    ...
    indvar_i_i_reg_122_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_i_reg_238 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_i_reg_238 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tx_buffer_V_addr_rea_reg_247 <= m_axi_tx_buffer_V_RDATA;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, ap_sig_ioackin_m_axi_tx_buffer_V_ARREADY, exitcond_i_i_fu_170_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2)
    begin
        case ap_CS_fsm is
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_tx_buffer_V_RVALID, ap_enable_reg_pp0_iter1, exitcond_i_i_reg_238)
    begin
                ap_block_pp0_stage0_11001 <= ((exitcond_i_i_reg_238 = ap_const_lv1_0) and (m_axi_tx_buffer_V_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_tx_buffer_V_RVALID, ap_enable_reg_pp0_iter1, exitcond_i_i_reg_238)
    begin
                ap_block_pp0_stage0_subdone <= ((exitcond_i_i_reg_238 = ap_const_lv1_0) and (m_axi_tx_buffer_V_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    ap_block_state10_pp0_stage0_iter1_assign_proc : process(m_axi_tx_buffer_V_RVALID, exitcond_i_i_reg_238)
    begin
                ap_block_state10_pp0_stage0_iter1 <= ((exitcond_i_i_reg_238 = ap_const_lv1_0) and (m_axi_tx_buffer_V_RVALID = ap_const_logic_0));
    end process;

        ap_block_state11_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state9_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state9_assign_proc : process(exitcond_i_i_fu_170_p2)
    begin
        if ((exitcond_i_i_fu_170_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_indvar_i_i_phi_fu_126_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_i_i_reg_238, indvar_i_i_reg_122, indvar_next_i_i_reg_242)
    begin
        if (((exitcond_i_i_reg_238 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state12, data_length_V_write_s_fu_205_p3, ap_return_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
    ...
    buffer_offset_V_fu_138_p3 <= (tmp_fu_134_p1 & ap_const_lv9_0);
    cache_V_address0 <= indvar1_i_i_fu_182_p1(9 - 1 downto 0);
    ...
    cache_V_d0 <= tx_buffer_V_addr_rea_reg_247;

    cache_V_we0_assign_proc : process(ap_block_pp0_stage0_11001, exitcond_i_i_reg_238_pp0_iter1_reg, ap_enable_reg_pp0_iter2)
    begin
        if (((exitcond_i_i_reg_238_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    data_length_V_write_s_fu_205_p3 <= 
        final_burst_length_V when (tmp_3_i_i_fu_199_p2(0) = '1') else 
        ap_const_lv11_400;
    exitcond_i_i_fu_170_p2 <= "1" when (ap_phi_mux_indvar_i_i_phi_fu_126_p4 = ap_const_lv10_200) else "0";
    indvar1_i_i_fu_182_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(indvar_i_i_reg_122_pp0_iter1_reg),64));
    indvar_next_i_i_fu_176_p2 <= std_logic_vector(unsigned(ap_phi_mux_indvar_i_i_phi_fu_126_p4) + unsigned(ap_const_lv10_1));
    lhs_V_cast_i_i_fu_187_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(loop_count_V),15));
    m_axi_tx_buffer_V_ARADDR <= sum_cast_i_fu_160_p1(32 - 1 downto 0);
    ...
    m_axi_tx_buffer_V_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond_i_i_reg_238, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond_i_i_reg_238 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    r_V_fu_190_p2 <= std_logic_vector(unsigned(lhs_V_cast_i_i_fu_187_p1) + unsigned(ap_const_lv15_7FFF));
    sext_cast_i_fu_150_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tx_buffer_V_offset),30));
    sum_cast_i_fu_160_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_i_reg_217),64));
    sum_i_fu_154_p2 <= std_logic_vector(unsigned(sext_cast_i_fu_150_p1) + unsigned(tmp_i_cast_i_fu_146_p1));
    tmp_2_cast_i_i_fu_196_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_reg_212),15));
    tmp_3_i_i_fu_199_p2 <= "1" when (tmp_2_cast_i_i_fu_196_p1 = r_V_fu_190_p2) else "0";
    tmp_fu_134_p1 <= val_assign(13 - 1 downto 0);
    tmp_i_cast_i_fu_146_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(buffer_offset_V_fu_138_p3),30));
    ...
    tx_buffer_V_blk_n_R_assign_proc : process(m_axi_tx_buffer_V_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_i_i_reg_238)
    begin
        if (((exitcond_i_i_reg_238 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
