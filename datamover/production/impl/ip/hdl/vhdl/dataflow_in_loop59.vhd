...
architecture behav of dataflow_in_loop59 is 
    ...
    signal read_burst_U0_ap_return : STD_LOGIC_VECTOR (10 downto 0);
    ...
    signal tx_axis_words_U0_axis_V_V_TDATA : STD_LOGIC_VECTOR (31 downto 0);
    ...
    signal data_length_V_dout : STD_LOGIC_VECTOR (10 downto 0);
    ...
    component dataflow_in_loop5bkb IS
    generic (
        DataWidth : INTEGER;
...
begin
    cache_V_U : component dataflow_in_loop5bkb
    generic map (
        DataWidth => 64,
        AddressRange => 512,
        AddressWidth => 9)
    ...
    data_length_V_U : component fifo_w11_d2_A
    port map (
        clk => ap_clk,
        reset => ap_rst,
