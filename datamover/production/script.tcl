...
export_design -flow impl -rtl vhdl -format ip_catalog -description "8-bit AXIS to 64-bit AXI data mover" -vendor "krtkl" -library "snickerdoodle" -version "1.10" -display_name "8-bit AXIS to 64-bit AXI data mover"
