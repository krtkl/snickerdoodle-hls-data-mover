...
architecture behav of read_burst is 
    ...
    signal exitcond_i_i_reg_251 : STD_LOGIC_VECTOR (0 downto 0);
    signal indvar_i_i_reg_133 : STD_LOGIC_VECTOR (9 downto 0);
    signal indvar_i_i_reg_133_pp0_iter1_reg : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_block_state9_pp0_stage0_iter0 : BOOLEAN;
    signal ap_block_state10_pp0_stage0_iter1 : BOOLEAN;
    signal ap_block_state11_pp0_stage0_iter2 : BOOLEAN;
    signal ap_block_pp0_stage0_11001 : BOOLEAN;
    signal tmp_fu_145_p1 : STD_LOGIC_VECTOR (10 downto 0);
    signal tmp_reg_225 : STD_LOGIC_VECTOR (10 downto 0);
    signal ap_block_state1 : BOOLEAN;
    signal sum_i_fu_167_p2 : STD_LOGIC_VECTOR (29 downto 0);
    signal sum_i_reg_230 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_sig_ioackin_m_axi_tx_buffer_V_ARREADY : STD_LOGIC;
    signal ap_CS_fsm_state8 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state8 : signal is "none";
    signal exitcond_i_i_fu_183_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal exitcond_i_i_reg_251_pp0_iter1_reg : STD_LOGIC_VECTOR (0 downto 0);
    signal indvar_next_i_i_fu_189_p2 : STD_LOGIC_VECTOR (9 downto 0);
    signal indvar_next_i_i_reg_255 : STD_LOGIC_VECTOR (9 downto 0);
    signal ap_enable_reg_pp0_iter0 : STD_LOGIC := '0';
    signal tx_buffer_V_addr_rea_reg_260 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_block_pp0_stage0_subdone : BOOLEAN;
    signal ap_condition_pp0_exit_iter0_state9 : STD_LOGIC;
    signal ap_enable_reg_pp0_iter2 : STD_LOGIC := '0';
    signal ap_phi_mux_indvar_i_i_phi_fu_137_p4 : STD_LOGIC_VECTOR (9 downto 0);
    signal indvar4_i_i_fu_195_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal sum_cast_i_fu_173_p1 : STD_LOGIC_VECTOR (63 downto 0);
    signal ap_reg_ioackin_m_axi_tx_buffer_V_ARREADY : STD_LOGIC := '0';
    signal tmp_7_i_fu_149_p4 : STD_LOGIC_VECTOR (20 downto 0);
    signal tmp_8_cast_i_fu_159_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal sext_cast_i_fu_163_p1 : STD_LOGIC_VECTOR (29 downto 0);
    signal ap_CS_fsm_state12 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state12 : signal is "none";
    signal lhs_V_cast_i_i_fu_200_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_2_cast_i_i_fu_209_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal r_V_fu_203_p2 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_3_i_i_fu_212_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal data_length_V_write_s_fu_218_p3 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
        ...
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst = '1') then
                ...
                if ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
                    ap_return_preg <= data_length_V_write_s_fu_218_p3;
                end if; 
            end if;
        end if;
    end process;
    ...
    indvar_i_i_reg_133_assign_proc : process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_i_reg_251 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
                indvar_i_i_reg_133 <= indvar_next_i_i_reg_255;
            elsif ((ap_const_logic_1 = ap_CS_fsm_state8)) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                exitcond_i_i_reg_251 <= exitcond_i_i_fu_183_p2;
                exitcond_i_i_reg_251_pp0_iter1_reg <= exitcond_i_i_reg_251;
                indvar_i_i_reg_133_pp0_iter1_reg <= indvar_i_i_reg_133;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_enable_reg_pp0_iter0 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                indvar_next_i_i_reg_255 <= indvar_next_i_i_fu_189_p2;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if ((not(((ap_start = ap_const_logic_0) or (ap_done_reg = ap_const_logic_1))) and (ap_const_logic_1 = ap_CS_fsm_state1))) then
                sum_i_reg_230 <= sum_i_fu_167_p2;
                tmp_reg_225 <= tmp_fu_145_p1;
            end if;
        end if;
    end process;
    process (ap_clk)
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((exitcond_i_i_reg_251 = ap_const_lv1_0) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then
                tx_buffer_V_addr_rea_reg_260 <= m_axi_tx_buffer_V_RDATA;
            end if;
        end if;
    end process;

    ap_NS_fsm_assign_proc : process (ap_start, ap_done_reg, ap_CS_fsm, ap_CS_fsm_state1, ap_CS_fsm_state2, ap_enable_reg_pp0_iter1, ap_sig_ioackin_m_axi_tx_buffer_V_ARREADY, exitcond_i_i_fu_183_p2, ap_enable_reg_pp0_iter0, ap_block_pp0_stage0_subdone, ap_enable_reg_pp0_iter2)
    begin
        case ap_CS_fsm is
    ...
    ap_block_pp0_stage0_11001_assign_proc : process(m_axi_tx_buffer_V_RVALID, ap_enable_reg_pp0_iter1, exitcond_i_i_reg_251)
    begin
                ap_block_pp0_stage0_11001 <= ((exitcond_i_i_reg_251 = ap_const_lv1_0) and (m_axi_tx_buffer_V_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;


    ap_block_pp0_stage0_subdone_assign_proc : process(m_axi_tx_buffer_V_RVALID, ap_enable_reg_pp0_iter1, exitcond_i_i_reg_251)
    begin
                ap_block_pp0_stage0_subdone <= ((exitcond_i_i_reg_251 = ap_const_lv1_0) and (m_axi_tx_buffer_V_RVALID = ap_const_logic_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1));
    end process;
    ...
    ap_block_state10_pp0_stage0_iter1_assign_proc : process(m_axi_tx_buffer_V_RVALID, exitcond_i_i_reg_251)
    begin
                ap_block_state10_pp0_stage0_iter1 <= ((exitcond_i_i_reg_251 = ap_const_lv1_0) and (m_axi_tx_buffer_V_RVALID = ap_const_logic_0));
    end process;

        ap_block_state11_pp0_stage0_iter2 <= not((ap_const_boolean_1 = ap_const_boolean_1));
        ap_block_state9_pp0_stage0_iter0 <= not((ap_const_boolean_1 = ap_const_boolean_1));

    ap_condition_pp0_exit_iter0_state9_assign_proc : process(exitcond_i_i_fu_183_p2)
    begin
        if ((exitcond_i_i_fu_183_p2 = ap_const_lv1_1)) then 
    ...
    ap_phi_mux_indvar_i_i_phi_fu_137_p4_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_i_i_reg_251, indvar_i_i_reg_133, indvar_next_i_i_reg_255)
    begin
        if (((exitcond_i_i_reg_251 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
            ap_phi_mux_indvar_i_i_phi_fu_137_p4 <= indvar_next_i_i_reg_255;
        else 
            ap_phi_mux_indvar_i_i_phi_fu_137_p4 <= indvar_i_i_reg_133;
        end if; 
    end process;
    ...
    ap_return_assign_proc : process(ap_CS_fsm_state12, data_length_V_write_s_fu_218_p3, ap_return_preg)
    begin
        if ((ap_const_logic_1 = ap_CS_fsm_state12)) then 
            ap_return <= data_length_V_write_s_fu_218_p3;
        else 
    ...
    cache_V_address0 <= indvar4_i_i_fu_195_p1(9 - 1 downto 0);
    ...
    cache_V_d0 <= tx_buffer_V_addr_rea_reg_260;

    cache_V_we0_assign_proc : process(ap_block_pp0_stage0_11001, exitcond_i_i_reg_251_pp0_iter1_reg, ap_enable_reg_pp0_iter2)
    begin
        if (((exitcond_i_i_reg_251_pp0_iter1_reg = ap_const_lv1_0) and (ap_enable_reg_pp0_iter2 = ap_const_logic_1) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    data_length_V_write_s_fu_218_p3 <= 
        final_burst_length_V when (tmp_3_i_i_fu_212_p2(0) = '1') else 
        ap_const_lv13_1000;
    exitcond_i_i_fu_183_p2 <= "1" when (ap_phi_mux_indvar_i_i_phi_fu_137_p4 = ap_const_lv10_200) else "0";
    indvar4_i_i_fu_195_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(indvar_i_i_reg_133_pp0_iter1_reg),64));
    indvar_next_i_i_fu_189_p2 <= std_logic_vector(unsigned(ap_phi_mux_indvar_i_i_phi_fu_137_p4) + unsigned(ap_const_lv10_1));
    lhs_V_cast_i_i_fu_200_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(loop_count_V),13));
    m_axi_tx_buffer_V_ARADDR <= sum_cast_i_fu_173_p1(32 - 1 downto 0);
    ...
    m_axi_tx_buffer_V_RREADY_assign_proc : process(ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, exitcond_i_i_reg_251, ap_block_pp0_stage0_11001)
    begin
        if (((exitcond_i_i_reg_251 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0_11001))) then 
    ...
    r_V_fu_203_p2 <= std_logic_vector(unsigned(lhs_V_cast_i_i_fu_200_p1) + unsigned(ap_const_lv13_1FFF));
    sext_cast_i_fu_163_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tx_buffer_V_offset),30));
    sum_cast_i_fu_173_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(sum_i_reg_230),64));
    sum_i_fu_167_p2 <= std_logic_vector(unsigned(tmp_8_cast_i_fu_159_p1) + unsigned(sext_cast_i_fu_163_p1));
    tmp_2_cast_i_i_fu_209_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_reg_225),13));
    tmp_3_i_i_fu_212_p2 <= "1" when (tmp_2_cast_i_i_fu_209_p1 = r_V_fu_203_p2) else "0";
    tmp_7_i_fu_149_p4 <= ((tx_buffer_V_offset1 & tmp_fu_145_p1) & ap_const_lv9_0);
    tmp_8_cast_i_fu_159_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(tmp_7_i_fu_149_p4),30));
    tmp_fu_145_p1 <= val_assign(11 - 1 downto 0);
    ...
    tx_buffer_V_blk_n_R_assign_proc : process(m_axi_tx_buffer_V_RVALID, ap_CS_fsm_pp0_stage0, ap_enable_reg_pp0_iter1, ap_block_pp0_stage0, exitcond_i_i_reg_251)
    begin
        if (((exitcond_i_i_reg_251 = ap_const_lv1_0) and (ap_enable_reg_pp0_iter1 = ap_const_logic_1) and (ap_const_logic_1 = ap_CS_fsm_pp0_stage0) and (ap_const_boolean_0 = ap_block_pp0_stage0))) then 
