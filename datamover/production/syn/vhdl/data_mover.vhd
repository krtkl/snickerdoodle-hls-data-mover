...
architecture behav of data_mover is 
    ...
    "data_mover,hls_ip_2018_1,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xc7z020clg400-3,HLS_INPUT_CLOCK=6.500000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=4.500000,HLS_SYN_LAT=-1,HLS_SYN_TPT=none,HLS_SYN_MEM=6,HLS_SYN_DSP=0,HLS_SYN_FF=1112,HLS_SYN_LUT=1834}";
    ...
    signal tx_buffer_V1_reg_150 : STD_LOGIC_VECTOR (28 downto 0);
    signal tx_final_burst_lengt_fu_132_p3 : STD_LOGIC_VECTOR (12 downto 0);
    signal tx_final_burst_lengt_reg_155 : STD_LOGIC_VECTOR (12 downto 0);
    signal tx_loop_count_V_fu_141_p3 : STD_LOGIC_VECTOR (12 downto 0);
    signal tx_loop_count_V_reg_160 : STD_LOGIC_VECTOR (12 downto 0);
    signal grp_tx_loop_fu_80_axis_V_V_TDATA : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWVALID : STD_LOGIC;
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWADDR : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_WVALID : STD_LOGIC;
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_WLAST : STD_LOGIC;
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARVALID : STD_LOGIC;
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARADDR : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_RREADY : STD_LOGIC;
    signal grp_tx_loop_fu_80_m_axi_tx_buffer_V_BREADY : STD_LOGIC;
    signal grp_tx_loop_fu_80_axis_V_V_TVALID : STD_LOGIC;
    signal grp_tx_loop_fu_80_axis_V_V_TREADY : STD_LOGIC;
    signal grp_tx_loop_fu_80_ap_done : STD_LOGIC;
    signal grp_tx_loop_fu_80_ap_start : STD_LOGIC;
    signal grp_tx_loop_fu_80_ap_ready : STD_LOGIC;
    signal grp_tx_loop_fu_80_ap_idle : STD_LOGIC;
    signal grp_tx_loop_fu_80_ap_continue : STD_LOGIC;
    signal grp_tx_loop_fu_80_ap_start_reg : STD_LOGIC := '0';
    signal ap_CS_fsm_state2 : STD_LOGIC;
    attribute fsm_encoding of ap_CS_fsm_state2 : signal is "none";
    signal ap_sync_grp_tx_loop_fu_80_ap_ready : STD_LOGIC;
    signal ap_sync_grp_tx_loop_fu_80_ap_done : STD_LOGIC;
    signal ap_block_state2_on_subcall_done : BOOLEAN;
    signal ap_sync_reg_grp_tx_loop_fu_80_ap_ready : STD_LOGIC := '0';
    signal ap_sync_reg_grp_tx_loop_fu_80_ap_done : STD_LOGIC := '0';
    signal r_V_fu_102_p1 : STD_LOGIC_VECTOR (11 downto 0);
    signal tmp_4_i_fu_112_p4 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_i_fu_106_p2 : STD_LOGIC_VECTOR (0 downto 0);
    signal tmp_6_i_cast_fu_122_p1 : STD_LOGIC_VECTOR (12 downto 0);
    signal tmp_9_i_fu_126_p2 : STD_LOGIC_VECTOR (12 downto 0);
...
begin
    ...
    grp_tx_loop_fu_80 : component tx_loop
    port map (
    ...
    ap_sync_reg_grp_tx_loop_fu_80_ap_done_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                    ap_sync_reg_grp_tx_loop_fu_80_ap_done <= ap_const_logic_0;
                elsif ((grp_tx_loop_fu_80_ap_done = ap_const_logic_1)) then 
    ...
    ap_sync_reg_grp_tx_loop_fu_80_ap_ready_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                ...
                if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
                    ap_sync_reg_grp_tx_loop_fu_80_ap_ready <= ap_const_logic_0;
                elsif ((grp_tx_loop_fu_80_ap_ready = ap_const_logic_1)) then 
    ...
    grp_tx_loop_fu_80_ap_start_reg_assign_proc : process(ap_clk)
    begin
        if (ap_clk'event and ap_clk =  '1') then
            if (ap_rst_n_inv = '1') then
                grp_tx_loop_fu_80_ap_start_reg <= ap_const_logic_0;
            else
                if ((((ap_sync_grp_tx_loop_fu_80_ap_ready = ap_const_logic_0) and (ap_const_logic_1 = ap_CS_fsm_state2)) or ((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1)))) then 
    ...
    begin
        if (ap_clk'event and ap_clk = '1') then
            if (((ap_const_logic_1 = ap_CS_fsm_state1) and (ap_start = ap_const_logic_1))) then
                tx_buffer_V1_reg_150 <= tx_buffer_V(31 downto 3);
    ...
    ap_NS_fsm_assign_proc : process (ap_start, ap_CS_fsm, ap_CS_fsm_state1, data_tx_V_V_1_ack_in, ap_CS_fsm_state2, ap_block_state2_on_subcall_done, ap_CS_fsm_state3)
    begin
        case ap_CS_fsm is
            ...
            when ap_ST_fsm_state3 => 
                if (((ap_const_logic_1 = ap_CS_fsm_state3) and (data_tx_V_V_1_ack_in = ap_const_logic_1))) then
                    ap_NS_fsm <= ap_ST_fsm_state1;
                else
                    ap_NS_fsm <= ap_ST_fsm_state3;
                end if;
    ...
    DMA_ARVALID_assign_proc : process(ap_CS_fsm_state1, grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARVALID, ap_CS_fsm_state2)
    begin
    ...
    DMA_RREADY_assign_proc : process(ap_CS_fsm_state1, grp_tx_loop_fu_80_m_axi_tx_buffer_V_RREADY, ap_CS_fsm_state2)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state2) or (ap_const_logic_1 = ap_CS_fsm_state1))) then 
    ...
    ap_block_state2_on_subcall_done_assign_proc : process(ap_sync_grp_tx_loop_fu_80_ap_ready, ap_sync_grp_tx_loop_fu_80_ap_done)
    begin
                ap_block_state2_on_subcall_done <= ((ap_sync_grp_tx_loop_fu_80_ap_ready and ap_sync_grp_tx_loop_fu_80_ap_done) = ap_const_logic_0);
    end process;


    ap_done_assign_proc : process(data_tx_V_V_1_ack_in, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (data_tx_V_V_1_ack_in = ap_const_logic_1))) then 
    ...
    ap_ready_assign_proc : process(data_tx_V_V_1_ack_in, ap_CS_fsm_state3)
    begin
        if (((ap_const_logic_1 = ap_CS_fsm_state3) and (data_tx_V_V_1_ack_in = ap_const_logic_1))) then 
    ...
    ap_sync_grp_tx_loop_fu_80_ap_done <= (grp_tx_loop_fu_80_ap_done or ap_sync_reg_grp_tx_loop_fu_80_ap_done);
    ap_sync_grp_tx_loop_fu_80_ap_ready <= (grp_tx_loop_fu_80_ap_ready or ap_sync_reg_grp_tx_loop_fu_80_ap_ready);
    ...
    data_tx_V_V_1_vld_in <= grp_tx_loop_fu_80_axis_V_V_TVALID;
    ...
    grp_tx_loop_fu_80_ap_continue_assign_proc : process(ap_CS_fsm_state2, ap_block_state2_on_subcall_done)
    begin
        if (((ap_const_boolean_0 = ap_block_state2_on_subcall_done) and (ap_const_logic_1 = ap_CS_fsm_state2))) then 
    ...
    grp_tx_loop_fu_80_ap_start <= grp_tx_loop_fu_80_ap_start_reg;
    grp_tx_loop_fu_80_axis_V_V_TREADY <= data_tx_V_V_1_state(1);
    r_V_fu_102_p1 <= tx_buffer_length_V(12 - 1 downto 0);
    tmp_4_i_fu_112_p4 <= tx_buffer_length_V(24 downto 12);
    tmp_6_i_cast_fu_122_p1 <= std_logic_vector(IEEE.numeric_std.resize(unsigned(r_V_fu_102_p1),13));
    tmp_9_i_fu_126_p2 <= std_logic_vector(unsigned(ap_const_lv13_1) + unsigned(tmp_4_i_fu_112_p4));
    tmp_i_fu_106_p2 <= "1" when (r_V_fu_102_p1 = ap_const_lv12_0) else "0";
    tx_final_burst_lengt_fu_132_p3 <= 
        ap_const_lv13_1000 when (tmp_i_fu_106_p2(0) = '1') else 
        tmp_6_i_cast_fu_122_p1;
    tx_loop_count_V_fu_141_p3 <= 
        tmp_4_i_fu_112_p4 when (tmp_i_fu_106_p2(0) = '1') else 
        tmp_9_i_fu_126_p2;
end behav;
