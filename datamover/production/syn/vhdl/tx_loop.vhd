...
architecture behav of tx_loop is 
    ...
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWID : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWREGION : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_AWUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_WVALID : STD_LOGIC;
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_WDATA : STD_LOGIC_VECTOR (63 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_WSTRB : STD_LOGIC_VECTOR (7 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_WLAST : STD_LOGIC;
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_WID : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_WUSER : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARVALID : STD_LOGIC;
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARADDR : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARID : STD_LOGIC_VECTOR (0 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARLEN : STD_LOGIC_VECTOR (31 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARSIZE : STD_LOGIC_VECTOR (2 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARBURST : STD_LOGIC_VECTOR (1 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARLOCK : STD_LOGIC_VECTOR (1 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARCACHE : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARPROT : STD_LOGIC_VECTOR (2 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARQOS : STD_LOGIC_VECTOR (3 downto 0);
    signal dataflow_in_loop59_U0_m_axi_tx_buffer_V_ARREGION : STD_LOGIC_VECTOR (3 downto 0);
    ...
    signal dataflow_in_loop59_U0_ap_ready : STD_LOGIC;
    signal dataflow_in_loop59_U0_ap_idle : STD_LOGIC;
    signal dataflow_in_loop59_U0_ap_continue : STD_LOGIC;
    ...
    component dataflow_in_loop59 IS
    port (
        ap_clk : IN STD_LOGIC;
        ap_rst : IN STD_LOGIC;
        m_axi_tx_buffer_V_AWVALID : OUT STD_LOGIC;
...
begin
    dataflow_in_loop59_U0 : component dataflow_in_loop59
    port map (
        ap_clk => ap_clk,
        ap_rst => ap_rst,
    ...
    ap_sync_done <= dataflow_in_loop59_U0_ap_done;
    ap_sync_ready <= dataflow_in_loop59_U0_ap_ready;
    axis_V_V_TDATA <= dataflow_in_loop59_U0_axis_V_V_TDATA;
    axis_V_V_TVALID <= dataflow_in_loop59_U0_axis_V_V_TVALID;
    dataflow_in_loop59_U0_ap_continue <= ap_const_logic_1;

    dataflow_in_loop59_U0_ap_start_assign_proc : process(loop_count_V, loop_dataflow_enable, loop_dataflow_input_count)
    begin
