...
wire    rx_axis_words6831_U0_ap_start;
wire    rx_axis_words6831_U0_ap_done;
wire    rx_axis_words6831_U0_ap_continue;
wire    rx_axis_words6831_U0_ap_idle;
wire    rx_axis_words6831_U0_ap_ready;
wire    rx_axis_words6831_U0_axis_V_V_TREADY;
wire   [8:0] rx_axis_words6831_U0_cache_V1_address0;
wire    rx_axis_words6831_U0_cache_V1_ce0;
wire    rx_axis_words6831_U0_cache_V1_we0;
wire   [63:0] rx_axis_words6831_U0_cache_V1_d0;
wire   [0:0] rx_axis_words6831_U0_rx_buffer_V_offset_out_din;
wire    rx_axis_words6831_U0_rx_buffer_V_offset_out_write;
wire   [28:0] rx_axis_words6831_U0_rx_buffer_V_offset1_out_din;
wire    rx_axis_words6831_U0_rx_buffer_V_offset1_out_write;
wire   [19:0] rx_axis_words6831_U0_ap_return;
...
wire    rx_axis_words6831_U0_cache_V1_full_n;
...
wire    ap_sync_done;
wire    ap_sync_ready;
wire    rx_axis_words6831_U0_start_full_n;
wire    rx_axis_words6831_U0_start_write;
...
rx_axis_words6831 rx_axis_words6831_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((rx_axis_words6831_U0_ap_done & rx_axis_words6831_U0_ap_continue) == 1'b1)) begin
            ap_sync_reg_channel_write_buffer_offset_V <= 1'b0;
        end else begin
...
assign ap_channel_done_buffer_offset_V = (rx_axis_words6831_U0_ap_done & (ap_sync_reg_channel_write_buffer_offset_V ^ 1'b1));

assign ap_channel_done_cache_V = (rx_axis_words6831_U0_ap_done & (ap_sync_reg_channel_write_cache_V ^ 1'b1));

assign ap_done = write_burst_U0_ap_done;

assign ap_idle = (write_burst_U0_ap_idle & rx_axis_words6831_U0_ap_idle & (buffer_offset_V_empty_n ^ 1'b1) & (cache_V_t_empty_n ^ 1'b1));

assign ap_ready = rx_axis_words6831_U0_ap_ready;
...
assign ap_sync_channel_write_cache_V = ((rx_axis_words6831_U0_cache_V1_full_n & ap_channel_done_cache_V) | ap_sync_reg_channel_write_cache_V);

assign ap_sync_continue = ap_continue;

assign ap_sync_done = write_burst_U0_ap_done;

assign ap_sync_ready = rx_axis_words6831_U0_ap_ready;

assign axis_V_V_TREADY = rx_axis_words6831_U0_axis_V_V_TREADY;
...
assign rx_axis_words6831_U0_ap_continue = (ap_sync_channel_write_cache_V & ap_sync_channel_write_buffer_offset_V);

assign rx_axis_words6831_U0_ap_start = ap_start;

assign rx_axis_words6831_U0_cache_V1_full_n = cache_V_i_full_n;

assign rx_axis_words6831_U0_start_full_n = 1'b1;

assign rx_axis_words6831_U0_start_write = 1'b0;
