...
wire    dataflow_in_loop_U0_m_axi_tx_buffer_V_AWVALID;
wire   [31:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWADDR;
wire   [0:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWID;
wire   [31:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWLEN;
wire   [2:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWSIZE;
wire   [1:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWBURST;
wire   [1:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWLOCK;
wire   [3:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWCACHE;
wire   [2:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWPROT;
wire   [3:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWQOS;
wire   [3:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWREGION;
wire   [0:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_AWUSER;
wire    dataflow_in_loop_U0_m_axi_tx_buffer_V_WVALID;
wire   [63:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_WDATA;
wire   [7:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_WSTRB;
wire    dataflow_in_loop_U0_m_axi_tx_buffer_V_WLAST;
wire   [0:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_WID;
wire   [0:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_WUSER;
wire    dataflow_in_loop_U0_m_axi_tx_buffer_V_ARVALID;
wire   [31:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARADDR;
wire   [0:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARID;
wire   [31:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARLEN;
wire   [2:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARSIZE;
wire   [1:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARBURST;
wire   [1:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARLOCK;
wire   [3:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARCACHE;
wire   [2:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARPROT;
wire   [3:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARQOS;
wire   [3:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARREGION;
wire   [0:0] dataflow_in_loop_U0_m_axi_tx_buffer_V_ARUSER;
wire    dataflow_in_loop_U0_m_axi_tx_buffer_V_RREADY;
wire    dataflow_in_loop_U0_m_axi_tx_buffer_V_BREADY;
wire   [7:0] dataflow_in_loop_U0_axis_V_V_TDATA;
wire    dataflow_in_loop_U0_axis_V_V_TVALID;
...
dataflow_in_loop dataflow_in_loop_U0(
    .ap_clk(ap_clk),
    .ap_rst(ap_rst),
    .m_axi_tx_buffer_V_AWVALID(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWVALID),
    .m_axi_tx_buffer_V_AWREADY(1'b0),
    .m_axi_tx_buffer_V_AWADDR(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWADDR),
    .m_axi_tx_buffer_V_AWID(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWID),
    .m_axi_tx_buffer_V_AWLEN(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWLEN),
    .m_axi_tx_buffer_V_AWSIZE(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWSIZE),
    .m_axi_tx_buffer_V_AWBURST(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWBURST),
    .m_axi_tx_buffer_V_AWLOCK(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWLOCK),
    .m_axi_tx_buffer_V_AWCACHE(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWCACHE),
    .m_axi_tx_buffer_V_AWPROT(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWPROT),
    .m_axi_tx_buffer_V_AWQOS(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWQOS),
    .m_axi_tx_buffer_V_AWREGION(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWREGION),
    .m_axi_tx_buffer_V_AWUSER(dataflow_in_loop_U0_m_axi_tx_buffer_V_AWUSER),
    .m_axi_tx_buffer_V_WVALID(dataflow_in_loop_U0_m_axi_tx_buffer_V_WVALID),
    .m_axi_tx_buffer_V_WREADY(1'b0),
    .m_axi_tx_buffer_V_WDATA(dataflow_in_loop_U0_m_axi_tx_buffer_V_WDATA),
    .m_axi_tx_buffer_V_WSTRB(dataflow_in_loop_U0_m_axi_tx_buffer_V_WSTRB),
    .m_axi_tx_buffer_V_WLAST(dataflow_in_loop_U0_m_axi_tx_buffer_V_WLAST),
    .m_axi_tx_buffer_V_WID(dataflow_in_loop_U0_m_axi_tx_buffer_V_WID),
    .m_axi_tx_buffer_V_WUSER(dataflow_in_loop_U0_m_axi_tx_buffer_V_WUSER),
    .m_axi_tx_buffer_V_ARVALID(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARVALID),
    .m_axi_tx_buffer_V_ARREADY(m_axi_tx_buffer_V_ARREADY),
    .m_axi_tx_buffer_V_ARADDR(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARADDR),
    .m_axi_tx_buffer_V_ARID(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARID),
    .m_axi_tx_buffer_V_ARLEN(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARLEN),
    .m_axi_tx_buffer_V_ARSIZE(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARSIZE),
    .m_axi_tx_buffer_V_ARBURST(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARBURST),
    .m_axi_tx_buffer_V_ARLOCK(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARLOCK),
    .m_axi_tx_buffer_V_ARCACHE(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARCACHE),
    .m_axi_tx_buffer_V_ARPROT(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARPROT),
    .m_axi_tx_buffer_V_ARQOS(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARQOS),
    .m_axi_tx_buffer_V_ARREGION(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARREGION),
    .m_axi_tx_buffer_V_ARUSER(dataflow_in_loop_U0_m_axi_tx_buffer_V_ARUSER),
    .m_axi_tx_buffer_V_RVALID(m_axi_tx_buffer_V_RVALID),
    .m_axi_tx_buffer_V_RREADY(dataflow_in_loop_U0_m_axi_tx_buffer_V_RREADY),
    ...
    .m_axi_tx_buffer_V_BREADY(dataflow_in_loop_U0_m_axi_tx_buffer_V_BREADY),
    ...
    .axis_V_V_TDATA(dataflow_in_loop_U0_axis_V_V_TDATA),
    ...
    .axis_V_V_TVALID(dataflow_in_loop_U0_axis_V_V_TVALID),
...
assign axis_V_V_TDATA = dataflow_in_loop_U0_axis_V_V_TDATA;

assign axis_V_V_TVALID = dataflow_in_loop_U0_axis_V_V_TVALID;
...
assign m_axi_tx_buffer_V_ARADDR = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARADDR;

assign m_axi_tx_buffer_V_ARBURST = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARBURST;

assign m_axi_tx_buffer_V_ARCACHE = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARCACHE;

assign m_axi_tx_buffer_V_ARID = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARID;

assign m_axi_tx_buffer_V_ARLEN = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARLEN;

assign m_axi_tx_buffer_V_ARLOCK = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARLOCK;

assign m_axi_tx_buffer_V_ARPROT = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARPROT;

assign m_axi_tx_buffer_V_ARQOS = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARQOS;

assign m_axi_tx_buffer_V_ARREGION = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARREGION;

assign m_axi_tx_buffer_V_ARSIZE = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARSIZE;

assign m_axi_tx_buffer_V_ARUSER = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARUSER;

assign m_axi_tx_buffer_V_ARVALID = dataflow_in_loop_U0_m_axi_tx_buffer_V_ARVALID;
...
assign m_axi_tx_buffer_V_RREADY = dataflow_in_loop_U0_m_axi_tx_buffer_V_RREADY;
