...
#ifndef _dataflow_in_loop63_HH_
#define _dataflow_in_loop63_HH_
...
struct dataflow_in_loop63 : public sc_module {
    ...
    // Module declarations
    dataflow_in_loop63(sc_module_name name);
    SC_HAS_PROCESS(dataflow_in_loop63);
