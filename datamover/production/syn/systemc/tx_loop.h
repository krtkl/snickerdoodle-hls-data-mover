...
struct tx_loop : public sc_module {
    ...
    sc_signal< sc_logic > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWVALID;
    sc_signal< sc_lv<32> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWADDR;
    sc_signal< sc_lv<1> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWID;
    sc_signal< sc_lv<32> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWLEN;
    sc_signal< sc_lv<3> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWSIZE;
    sc_signal< sc_lv<2> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWBURST;
    sc_signal< sc_lv<2> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWLOCK;
    sc_signal< sc_lv<4> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWCACHE;
    sc_signal< sc_lv<3> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWPROT;
    sc_signal< sc_lv<4> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWQOS;
    sc_signal< sc_lv<4> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWREGION;
    sc_signal< sc_lv<1> > dataflow_in_loop_U0_m_axi_tx_buffer_V_AWUSER;
    sc_signal< sc_logic > dataflow_in_loop_U0_m_axi_tx_buffer_V_WVALID;
    sc_signal< sc_lv<64> > dataflow_in_loop_U0_m_axi_tx_buffer_V_WDATA;
    sc_signal< sc_lv<8> > dataflow_in_loop_U0_m_axi_tx_buffer_V_WSTRB;
    sc_signal< sc_logic > dataflow_in_loop_U0_m_axi_tx_buffer_V_WLAST;
    sc_signal< sc_lv<1> > dataflow_in_loop_U0_m_axi_tx_buffer_V_WID;
    sc_signal< sc_lv<1> > dataflow_in_loop_U0_m_axi_tx_buffer_V_WUSER;
    sc_signal< sc_logic > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARVALID;
    sc_signal< sc_lv<32> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARADDR;
    sc_signal< sc_lv<1> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARID;
    sc_signal< sc_lv<32> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARLEN;
    sc_signal< sc_lv<3> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARSIZE;
    sc_signal< sc_lv<2> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARBURST;
    sc_signal< sc_lv<2> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARLOCK;
    sc_signal< sc_lv<4> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARCACHE;
    sc_signal< sc_lv<3> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARPROT;
    sc_signal< sc_lv<4> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARQOS;
    sc_signal< sc_lv<4> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARREGION;
    sc_signal< sc_lv<1> > dataflow_in_loop_U0_m_axi_tx_buffer_V_ARUSER;
    sc_signal< sc_logic > dataflow_in_loop_U0_m_axi_tx_buffer_V_RREADY;
    sc_signal< sc_logic > dataflow_in_loop_U0_m_axi_tx_buffer_V_BREADY;
    sc_signal< sc_lv<8> > dataflow_in_loop_U0_axis_V_V_TDATA;
    sc_signal< sc_logic > dataflow_in_loop_U0_axis_V_V_TVALID;
