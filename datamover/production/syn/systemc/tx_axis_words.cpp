...
tx_axis_words::tx_axis_words(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    SC_METHOD(thread_p_lshr_f_cast_i_fu_98_p4);
    sensitive << ( i_i_reg_76 );

    SC_METHOD(thread_tmp_4_i_fu_108_p1);
    sensitive << ( p_lshr_f_cast_i_fu_98_p4 );

    SC_METHOD(thread_tmp_7_i_fu_124_p1);
    sensitive << ( op2_assign_fu_117_p3 );

    SC_METHOD(thread_tmp_8_i_fu_128_p2);
    sensitive << ( axi_word_V_reg_162 );
    sensitive << ( tmp_7_i_fu_124_p1 );
    ...
    sc_trace(mVcdFile, tmp_4_i_fu_108_p1, "tmp_4_i_fu_108_p1");
    sc_trace(mVcdFile, ap_block_pp0_stage0_01001, "ap_block_pp0_stage0_01001");
    sc_trace(mVcdFile, ap_reg_ioackin_axis_V_V_TREADY, "ap_reg_ioackin_axis_V_V_TREADY");
    sc_trace(mVcdFile, p_lshr_f_cast_i_fu_98_p4, "p_lshr_f_cast_i_fu_98_p4");
    sc_trace(mVcdFile, op2_assign_fu_117_p3, "op2_assign_fu_117_p3");
    sc_trace(mVcdFile, tmp_7_i_fu_124_p1, "tmp_7_i_fu_124_p1");
    sc_trace(mVcdFile, tmp_8_i_fu_128_p2, "tmp_8_i_fu_128_p2");
...
void tx_axis_words::thread_axis_V_V_TDATA() {
    axis_V_V_TDATA = tmp_8_i_fu_128_p2.read().range(8-1, 0);
}
...
void tx_axis_words::thread_cache_V_address0() {
    cache_V_address0 =  (sc_lv<9>) (tmp_4_i_fu_108_p1.read());
}
...
void tx_axis_words::thread_i_fu_92_p2() {
    i_fu_92_p2 = (!i_i_reg_76.read().is_01() || !ap_const_lv13_1.is_01())? sc_lv<13>(): (sc_biguint<13>(i_i_reg_76.read()) + sc_biguint<13>(ap_const_lv13_1));
}

void tx_axis_words::thread_op2_assign_fu_117_p3() {
    op2_assign_fu_117_p3 = esl_concat<3,3>(tmp_reg_157_pp0_iter1_reg.read(), ap_const_lv3_0);
}

void tx_axis_words::thread_p_lshr_f_cast_i_fu_98_p4() {
    p_lshr_f_cast_i_fu_98_p4 = i_i_reg_76.read().range(12, 3);
}

void tx_axis_words::thread_tmp_4_i_fu_108_p1() {
    tmp_4_i_fu_108_p1 = esl_zext<64,10>(p_lshr_f_cast_i_fu_98_p4.read());
}

void tx_axis_words::thread_tmp_7_i_fu_124_p1() {
    tmp_7_i_fu_124_p1 = esl_zext<64,6>(op2_assign_fu_117_p3.read());
}

void tx_axis_words::thread_tmp_8_i_fu_128_p2() {
    tmp_8_i_fu_128_p2 = (!tmp_7_i_fu_124_p1.read().is_01())? sc_lv<64>(): axi_word_V_reg_162.read() >> (unsigned short)tmp_7_i_fu_124_p1.read().to_uint();
}

void tx_axis_words::thread_tmp_fu_113_p1() {
    tmp_fu_113_p1 = i_i_reg_76.read().range(3-1, 0);
}
