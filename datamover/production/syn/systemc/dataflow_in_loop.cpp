...
dataflow_in_loop::dataflow_in_loop(sc_module_name name) : sc_module(name), mVcdFile(0) {
    ...
    cache_V_U->i_address0(rx_axis_words6831_U0_cache_V1_address0);
    cache_V_U->i_ce0(rx_axis_words6831_U0_cache_V1_ce0);
    cache_V_U->i_we0(rx_axis_words6831_U0_cache_V1_we0);
    cache_V_U->i_d0(rx_axis_words6831_U0_cache_V1_d0);
    ...
    rx_axis_words6831_U0 = new rx_axis_words6831("rx_axis_words6831_U0");
    rx_axis_words6831_U0->ap_clk(ap_clk);
    rx_axis_words6831_U0->ap_rst(ap_rst);
    rx_axis_words6831_U0->ap_start(rx_axis_words6831_U0_ap_start);
    rx_axis_words6831_U0->ap_done(rx_axis_words6831_U0_ap_done);
    rx_axis_words6831_U0->ap_continue(rx_axis_words6831_U0_ap_continue);
    rx_axis_words6831_U0->ap_idle(rx_axis_words6831_U0_ap_idle);
    rx_axis_words6831_U0->ap_ready(rx_axis_words6831_U0_ap_ready);
    rx_axis_words6831_U0->axis_V_V_TDATA(axis_V_V_TDATA);
    rx_axis_words6831_U0->axis_V_V_TVALID(axis_V_V_TVALID);
    rx_axis_words6831_U0->axis_V_V_TREADY(rx_axis_words6831_U0_axis_V_V_TREADY);
    rx_axis_words6831_U0->loop_count_V(loop_count_V);
    rx_axis_words6831_U0->final_burst_length_V(final_burst_length_V);
    rx_axis_words6831_U0->val_assign(val_assign);
    rx_axis_words6831_U0->cache_V1_address0(rx_axis_words6831_U0_cache_V1_address0);
    rx_axis_words6831_U0->cache_V1_ce0(rx_axis_words6831_U0_cache_V1_ce0);
    rx_axis_words6831_U0->cache_V1_we0(rx_axis_words6831_U0_cache_V1_we0);
    rx_axis_words6831_U0->cache_V1_d0(rx_axis_words6831_U0_cache_V1_d0);
    rx_axis_words6831_U0->rx_buffer_V_offset(rx_buffer_V_offset1);
    rx_axis_words6831_U0->rx_buffer_V_offset_out_din(rx_axis_words6831_U0_rx_buffer_V_offset_out_din);
    rx_axis_words6831_U0->rx_buffer_V_offset_out_full_n(rx_buffer_V_offset_c_full_n);
    rx_axis_words6831_U0->rx_buffer_V_offset_out_write(rx_axis_words6831_U0_rx_buffer_V_offset_out_write);
    rx_axis_words6831_U0->rx_buffer_V_offset1(rx_buffer_V_offset);
    rx_axis_words6831_U0->rx_buffer_V_offset1_out_din(rx_axis_words6831_U0_rx_buffer_V_offset1_out_din);
    rx_axis_words6831_U0->rx_buffer_V_offset1_out_full_n(rx_buffer_V_offset_c_2_full_n);
    rx_axis_words6831_U0->rx_buffer_V_offset1_out_write(rx_axis_words6831_U0_rx_buffer_V_offset1_out_write);
    rx_axis_words6831_U0->ap_return(rx_axis_words6831_U0_ap_return);
    ...
    rx_buffer_V_offset_c_U->if_din(rx_axis_words6831_U0_rx_buffer_V_offset_out_din);
    rx_buffer_V_offset_c_U->if_full_n(rx_buffer_V_offset_c_full_n);
    rx_buffer_V_offset_c_U->if_write(rx_axis_words6831_U0_rx_buffer_V_offset_out_write);
    ...
    rx_buffer_V_offset_c_2_U->if_din(rx_axis_words6831_U0_rx_buffer_V_offset1_out_din);
    rx_buffer_V_offset_c_2_U->if_full_n(rx_buffer_V_offset_c_2_full_n);
    rx_buffer_V_offset_c_2_U->if_write(rx_axis_words6831_U0_rx_buffer_V_offset1_out_write);
    ...
    buffer_offset_V_U->if_din(rx_axis_words6831_U0_ap_return);
    ...
    sensitive << ( rx_axis_words6831_U0_ap_done );
    ...
    sensitive << ( rx_axis_words6831_U0_cache_V1_full_n );
    sensitive << ( ap_sync_reg_channel_write_cache_V );
    ...
    sensitive << ( rx_axis_words6831_U0_axis_V_V_TREADY );
    ...
    SC_METHOD(thread_rx_axis_words6831_U0_ap_continue);
    sensitive << ( ap_sync_channel_write_buffer_offset_V );
    sensitive << ( ap_sync_channel_write_cache_V );

    SC_METHOD(thread_rx_axis_words6831_U0_ap_start);
    sensitive << ( ap_start );

    SC_METHOD(thread_rx_axis_words6831_U0_cache_V1_full_n);
    sensitive << ( cache_V_i_full_n );

    SC_METHOD(thread_rx_axis_words6831_U0_start_full_n);

    SC_METHOD(thread_rx_axis_words6831_U0_start_write);
    ...
    sc_trace(mVcdFile, rx_axis_words6831_U0_ap_start, "rx_axis_words6831_U0_ap_start");
    sc_trace(mVcdFile, rx_axis_words6831_U0_ap_done, "rx_axis_words6831_U0_ap_done");
    sc_trace(mVcdFile, rx_axis_words6831_U0_ap_continue, "rx_axis_words6831_U0_ap_continue");
    sc_trace(mVcdFile, rx_axis_words6831_U0_ap_idle, "rx_axis_words6831_U0_ap_idle");
    sc_trace(mVcdFile, rx_axis_words6831_U0_ap_ready, "rx_axis_words6831_U0_ap_ready");
    sc_trace(mVcdFile, rx_axis_words6831_U0_axis_V_V_TREADY, "rx_axis_words6831_U0_axis_V_V_TREADY");
    sc_trace(mVcdFile, rx_axis_words6831_U0_cache_V1_address0, "rx_axis_words6831_U0_cache_V1_address0");
    sc_trace(mVcdFile, rx_axis_words6831_U0_cache_V1_ce0, "rx_axis_words6831_U0_cache_V1_ce0");
    sc_trace(mVcdFile, rx_axis_words6831_U0_cache_V1_we0, "rx_axis_words6831_U0_cache_V1_we0");
    sc_trace(mVcdFile, rx_axis_words6831_U0_cache_V1_d0, "rx_axis_words6831_U0_cache_V1_d0");
    sc_trace(mVcdFile, rx_axis_words6831_U0_rx_buffer_V_offset_out_din, "rx_axis_words6831_U0_rx_buffer_V_offset_out_din");
    sc_trace(mVcdFile, rx_axis_words6831_U0_rx_buffer_V_offset_out_write, "rx_axis_words6831_U0_rx_buffer_V_offset_out_write");
    sc_trace(mVcdFile, rx_axis_words6831_U0_rx_buffer_V_offset1_out_din, "rx_axis_words6831_U0_rx_buffer_V_offset1_out_din");
    sc_trace(mVcdFile, rx_axis_words6831_U0_rx_buffer_V_offset1_out_write, "rx_axis_words6831_U0_rx_buffer_V_offset1_out_write");
    sc_trace(mVcdFile, rx_axis_words6831_U0_ap_return, "rx_axis_words6831_U0_ap_return");
    ...
    sc_trace(mVcdFile, rx_axis_words6831_U0_cache_V1_full_n, "rx_axis_words6831_U0_cache_V1_full_n");
    ...
    sc_trace(mVcdFile, rx_axis_words6831_U0_start_full_n, "rx_axis_words6831_U0_start_full_n");
    sc_trace(mVcdFile, rx_axis_words6831_U0_start_write, "rx_axis_words6831_U0_start_write");
...
void dataflow_in_loop::thread_ap_clk_no_reset_() {
    if ( ap_rst.read() == ap_const_logic_1) {
        ...
        if (esl_seteq<1,1,1>(ap_const_logic_1, (rx_axis_words6831_U0_ap_done.read() & 
             rx_axis_words6831_U0_ap_continue.read()))) {
            ap_sync_reg_channel_write_buffer_offset_V = ap_const_logic_0;
        } else {
...
void dataflow_in_loop::thread_ap_channel_done_buffer_offset_V() {
    ap_channel_done_buffer_offset_V = (rx_axis_words6831_U0_ap_done.read() & (ap_sync_reg_channel_write_buffer_offset_V.read() ^ 
  ap_const_logic_1));
}

void dataflow_in_loop::thread_ap_channel_done_cache_V() {
    ap_channel_done_cache_V = (rx_axis_words6831_U0_ap_done.read() & (ap_sync_reg_channel_write_cache_V.read() ^ 
  ap_const_logic_1));
}
...
void dataflow_in_loop::thread_ap_idle() {
    ap_idle = (rx_axis_words6831_U0_ap_idle.read() & write_burst_U0_ap_idle.read() & (cache_V_t_empty_n.read() ^ 
  ap_const_logic_1) & (buffer_offset_V_empty_n.read() ^ 
  ap_const_logic_1));
}

void dataflow_in_loop::thread_ap_ready() {
    ap_ready = rx_axis_words6831_U0_ap_ready.read();
}
...
void dataflow_in_loop::thread_ap_sync_channel_write_cache_V() {
  ...
  rx_axis_words6831_U0_cache_V1_full_n.read()) | ap_sync_reg_channel_write_cache_V.read());
}
...
void dataflow_in_loop::thread_ap_sync_ready() {
    ap_sync_ready = rx_axis_words6831_U0_ap_ready.read();
}

void dataflow_in_loop::thread_axis_V_V_TREADY() {
    axis_V_V_TREADY = rx_axis_words6831_U0_axis_V_V_TREADY.read();
}
...
void dataflow_in_loop::thread_rx_axis_words6831_U0_ap_continue() {
    rx_axis_words6831_U0_ap_continue = (ap_sync_channel_write_buffer_offset_V.read() & ap_sync_channel_write_cache_V.read());
}

void dataflow_in_loop::thread_rx_axis_words6831_U0_ap_start() {
    rx_axis_words6831_U0_ap_start = ap_start.read();
}

void dataflow_in_loop::thread_rx_axis_words6831_U0_cache_V1_full_n() {
    rx_axis_words6831_U0_cache_V1_full_n = cache_V_i_full_n.read();
}

void dataflow_in_loop::thread_rx_axis_words6831_U0_start_full_n() {
    rx_axis_words6831_U0_start_full_n = ap_const_logic_1;
}

void dataflow_in_loop::thread_rx_axis_words6831_U0_start_write() {
