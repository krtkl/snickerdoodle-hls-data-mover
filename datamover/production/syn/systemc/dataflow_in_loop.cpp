...
const sc_lv<8> dataflow_in_loop::ap_const_lv8_0 = "00000000";
...
dataflow_in_loop::dataflow_in_loop(sc_module_name name) : sc_module(name), mVcdFile(0) {
    cache_V_U = new dataflow_in_loop_bkb("cache_V_U");
...
void dataflow_in_loop::thread_ap_channel_done_data_length_V() {
...
void dataflow_in_loop::thread_ap_sync_channel_write_data_length_V() {
...
void dataflow_in_loop::thread_axis_V_V_TDATA() {
    axis_V_V_TDATA = tx_axis_words_U0_axis_V_V_TDATA.read();
}

void dataflow_in_loop::thread_axis_V_V_TVALID() {
    axis_V_V_TVALID = tx_axis_words_U0_axis_V_V_TVALID.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARADDR() {
    m_axi_tx_buffer_V_ARADDR = read_burst_U0_m_axi_tx_buffer_V_ARADDR.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARBURST() {
    m_axi_tx_buffer_V_ARBURST = read_burst_U0_m_axi_tx_buffer_V_ARBURST.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARCACHE() {
    m_axi_tx_buffer_V_ARCACHE = read_burst_U0_m_axi_tx_buffer_V_ARCACHE.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARID() {
    m_axi_tx_buffer_V_ARID = read_burst_U0_m_axi_tx_buffer_V_ARID.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARLEN() {
    m_axi_tx_buffer_V_ARLEN = read_burst_U0_m_axi_tx_buffer_V_ARLEN.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARLOCK() {
    m_axi_tx_buffer_V_ARLOCK = read_burst_U0_m_axi_tx_buffer_V_ARLOCK.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARPROT() {
    m_axi_tx_buffer_V_ARPROT = read_burst_U0_m_axi_tx_buffer_V_ARPROT.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARQOS() {
    m_axi_tx_buffer_V_ARQOS = read_burst_U0_m_axi_tx_buffer_V_ARQOS.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARREGION() {
    m_axi_tx_buffer_V_ARREGION = read_burst_U0_m_axi_tx_buffer_V_ARREGION.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARSIZE() {
    m_axi_tx_buffer_V_ARSIZE = read_burst_U0_m_axi_tx_buffer_V_ARSIZE.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARUSER() {
    m_axi_tx_buffer_V_ARUSER = read_burst_U0_m_axi_tx_buffer_V_ARUSER.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_ARVALID() {
    m_axi_tx_buffer_V_ARVALID = read_burst_U0_m_axi_tx_buffer_V_ARVALID.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWADDR() {
    m_axi_tx_buffer_V_AWADDR = ap_const_lv32_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWBURST() {
    m_axi_tx_buffer_V_AWBURST = ap_const_lv2_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWCACHE() {
    m_axi_tx_buffer_V_AWCACHE = ap_const_lv4_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWID() {
    m_axi_tx_buffer_V_AWID = ap_const_lv1_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWLEN() {
    m_axi_tx_buffer_V_AWLEN = ap_const_lv32_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWLOCK() {
    m_axi_tx_buffer_V_AWLOCK = ap_const_lv2_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWPROT() {
    m_axi_tx_buffer_V_AWPROT = ap_const_lv3_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWQOS() {
    m_axi_tx_buffer_V_AWQOS = ap_const_lv4_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWREGION() {
    m_axi_tx_buffer_V_AWREGION = ap_const_lv4_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWSIZE() {
    m_axi_tx_buffer_V_AWSIZE = ap_const_lv3_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWUSER() {
    m_axi_tx_buffer_V_AWUSER = ap_const_lv1_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_AWVALID() {
    m_axi_tx_buffer_V_AWVALID = ap_const_logic_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_BREADY() {
    m_axi_tx_buffer_V_BREADY = ap_const_logic_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_RREADY() {
    m_axi_tx_buffer_V_RREADY = read_burst_U0_m_axi_tx_buffer_V_RREADY.read();
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_WDATA() {
    m_axi_tx_buffer_V_WDATA = ap_const_lv64_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_WID() {
    m_axi_tx_buffer_V_WID = ap_const_lv1_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_WLAST() {
    m_axi_tx_buffer_V_WLAST = ap_const_logic_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_WSTRB() {
    m_axi_tx_buffer_V_WSTRB = ap_const_lv8_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_WUSER() {
    m_axi_tx_buffer_V_WUSER = ap_const_lv1_0;
}

void dataflow_in_loop::thread_m_axi_tx_buffer_V_WVALID() {
    m_axi_tx_buffer_V_WVALID = ap_const_logic_0;
}

void dataflow_in_loop::thread_read_burst_U0_ap_continue() {
    read_burst_U0_ap_continue = (ap_sync_channel_write_data_length_V.read() & ap_sync_channel_write_cache_V.read());
}

void dataflow_in_loop::thread_read_burst_U0_ap_start() {
    read_burst_U0_ap_start = ap_start.read();
}

void dataflow_in_loop::thread_read_burst_U0_cache_V_full_n() {
    read_burst_U0_cache_V_full_n = cache_V_i_full_n.read();
}

void dataflow_in_loop::thread_read_burst_U0_start_full_n() {
    read_burst_U0_start_full_n = ap_const_logic_1;
}

void dataflow_in_loop::thread_read_burst_U0_start_write() {
    read_burst_U0_start_write = ap_const_logic_0;
}

void dataflow_in_loop::thread_tx_axis_words_U0_ap_continue() {
    tx_axis_words_U0_ap_continue = ap_continue.read();
}

void dataflow_in_loop::thread_tx_axis_words_U0_ap_start() {
    tx_axis_words_U0_ap_start = (cache_V_t_empty_n.read() & data_length_V_empty_n.read());
}

void dataflow_in_loop::thread_tx_axis_words_U0_start_full_n() {
    tx_axis_words_U0_start_full_n = ap_const_logic_1;
}

void dataflow_in_loop::thread_tx_axis_words_U0_start_write() {
