...
struct data_mover : public sc_module {
    ...
    sc_signal< sc_lv<29> > rx_buffer_V3_reg_282;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_lv<29> > tx_buffer_V1_reg_287;
    sc_signal< sc_lv<1> > buffer_no_V_reg_292;
    sc_signal< sc_lv<13> > tx_final_burst_lengt_fu_210_p3;
    sc_signal< sc_lv<13> > tx_final_burst_lengt_reg_300;
    sc_signal< sc_lv<12> > tx_loop_count_V_fu_219_p3;
    sc_signal< sc_lv<12> > tx_loop_count_V_reg_305;
    sc_signal< sc_lv<13> > rx_final_burst_lengt_fu_258_p3;
    ...
    sc_signal< sc_lv<32> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_AWLEN;
    sc_signal< sc_lv<3> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_AWSIZE;
    sc_signal< sc_lv<2> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_AWBURST;
    sc_signal< sc_lv<2> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_AWLOCK;
    sc_signal< sc_lv<4> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_AWCACHE;
    sc_signal< sc_lv<3> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_AWPROT;
    sc_signal< sc_lv<4> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_AWQOS;
    sc_signal< sc_lv<4> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_AWREGION;
    sc_signal< sc_lv<1> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_AWUSER;
    sc_signal< sc_logic > grp_rx_loop_fu_132_m_axi_rx_buffer_V_WVALID;
    sc_signal< sc_lv<64> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_WDATA;
    sc_signal< sc_lv<8> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_WSTRB;
    sc_signal< sc_logic > grp_rx_loop_fu_132_m_axi_rx_buffer_V_WLAST;
    sc_signal< sc_lv<1> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_WID;
    sc_signal< sc_lv<1> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_WUSER;
    sc_signal< sc_logic > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARVALID;
    sc_signal< sc_lv<32> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARADDR;
    sc_signal< sc_lv<1> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARID;
    sc_signal< sc_lv<32> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARLEN;
    sc_signal< sc_lv<3> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARSIZE;
    sc_signal< sc_lv<2> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARBURST;
    sc_signal< sc_lv<2> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARLOCK;
    sc_signal< sc_lv<4> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARCACHE;
    sc_signal< sc_lv<3> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARPROT;
    sc_signal< sc_lv<4> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARQOS;
    sc_signal< sc_lv<4> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARREGION;
    sc_signal< sc_lv<1> > grp_rx_loop_fu_132_m_axi_rx_buffer_V_ARUSER;
    sc_signal< sc_logic > grp_rx_loop_fu_132_m_axi_rx_buffer_V_RREADY;
    sc_signal< sc_logic > grp_rx_loop_fu_132_m_axi_rx_buffer_V_BREADY;
    sc_signal< sc_logic > grp_rx_loop_fu_132_axis_V_V_TVALID;
    sc_signal< sc_logic > grp_rx_loop_fu_132_axis_V_V_TREADY;
    sc_signal< sc_logic > grp_rx_loop_fu_132_ap_done;
    sc_signal< sc_logic > grp_rx_loop_fu_132_ap_start;
    sc_signal< sc_logic > grp_rx_loop_fu_132_ap_ready;
    sc_signal< sc_logic > grp_rx_loop_fu_132_ap_idle;
    sc_signal< sc_logic > grp_rx_loop_fu_132_ap_continue;
    sc_signal< sc_lv<8> > grp_tx_loop_fu_145_axis_V_V_TDATA;
    sc_signal< sc_logic > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWVALID;
    sc_signal< sc_lv<32> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWADDR;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWID;
    sc_signal< sc_lv<32> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWLEN;
    sc_signal< sc_lv<3> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWSIZE;
    sc_signal< sc_lv<2> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWBURST;
    sc_signal< sc_lv<2> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWLOCK;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWCACHE;
    sc_signal< sc_lv<3> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWPROT;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWQOS;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWREGION;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_AWUSER;
    sc_signal< sc_logic > grp_tx_loop_fu_145_m_axi_tx_buffer_V_WVALID;
    sc_signal< sc_lv<64> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_WDATA;
    sc_signal< sc_lv<8> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_WSTRB;
    sc_signal< sc_logic > grp_tx_loop_fu_145_m_axi_tx_buffer_V_WLAST;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_WID;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_WUSER;
    sc_signal< sc_logic > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARVALID;
    sc_signal< sc_lv<32> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARADDR;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARID;
    sc_signal< sc_lv<32> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARLEN;
    sc_signal< sc_lv<3> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARSIZE;
    sc_signal< sc_lv<2> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARBURST;
    sc_signal< sc_lv<2> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARLOCK;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARCACHE;
    sc_signal< sc_lv<3> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARPROT;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARQOS;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARREGION;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_145_m_axi_tx_buffer_V_ARUSER;
    sc_signal< sc_logic > grp_tx_loop_fu_145_m_axi_tx_buffer_V_RREADY;
    sc_signal< sc_logic > grp_tx_loop_fu_145_m_axi_tx_buffer_V_BREADY;
    sc_signal< sc_logic > grp_tx_loop_fu_145_axis_V_V_TVALID;
    sc_signal< sc_logic > grp_tx_loop_fu_145_axis_V_V_TREADY;
    sc_signal< sc_logic > grp_tx_loop_fu_145_ap_done;
    sc_signal< sc_logic > grp_tx_loop_fu_145_ap_start;
    sc_signal< sc_logic > grp_tx_loop_fu_145_ap_ready;
    sc_signal< sc_logic > grp_tx_loop_fu_145_ap_idle;
    sc_signal< sc_logic > grp_tx_loop_fu_145_ap_continue;
    sc_signal< sc_logic > grp_rx_loop_fu_132_ap_start_reg;
    sc_signal< sc_logic > ap_CS_fsm_state3;
    sc_signal< sc_logic > ap_sync_grp_tx_loop_fu_145_ap_ready;
    sc_signal< sc_logic > ap_sync_grp_tx_loop_fu_145_ap_done;
    sc_signal< sc_logic > ap_sync_grp_rx_loop_fu_132_ap_ready;
    sc_signal< sc_logic > ap_sync_grp_rx_loop_fu_132_ap_done;
    sc_signal< bool > ap_block_state3_on_subcall_done;
    sc_signal< sc_logic > ap_sync_reg_grp_rx_loop_fu_132_ap_ready;
    sc_signal< sc_logic > ap_sync_reg_grp_rx_loop_fu_132_ap_done;
    ...
    sc_signal< sc_lv<13> > tmp_6_i_cast_fu_200_p1;
    sc_signal< sc_lv<12> > tmp_9_i_fu_204_p2;
    sc_signal< sc_lv<12> > r_V_1_fu_228_p1;
    sc_signal< sc_lv<12> > tmp_4_i1_fu_238_p4;
    sc_signal< sc_lv<1> > tmp_i1_fu_232_p2;
    sc_signal< sc_lv<13> > tmp_6_i19_cast_fu_248_p1;
    sc_signal< sc_lv<12> > tmp_9_i1_fu_252_p2;
    ...
    void thread_ap_sync_grp_rx_loop_fu_132_ap_done();
    void thread_ap_sync_grp_rx_loop_fu_132_ap_ready();
    void thread_ap_sync_grp_tx_loop_fu_145_ap_done();
    void thread_ap_sync_grp_tx_loop_fu_145_ap_ready();
    void thread_current_buffer_V_o();
    void thread_current_buffer_V_o_ap_vld();
    ...
    void thread_grp_rx_loop_fu_132_ap_continue();
    void thread_grp_rx_loop_fu_132_ap_start();
    void thread_grp_rx_loop_fu_132_axis_V_V_TVALID();
    ...
    void thread_rx_final_burst_lengt_fu_258_p3();
    void thread_rx_loop_count_V_fu_267_p3();
    void thread_tmp_4_i1_fu_238_p4();
    void thread_tmp_4_i_fu_190_p4();
    void thread_tmp_6_i19_cast_fu_248_p1();
    void thread_tmp_6_i_cast_fu_200_p1();
    void thread_tmp_9_i1_fu_252_p2();
    void thread_tmp_9_i_fu_204_p2();
    void thread_tmp_i1_fu_232_p2();
    void thread_tmp_i_fu_184_p2();
    void thread_tx_final_burst_lengt_fu_210_p3();
    void thread_tx_loop_count_V_fu_219_p3();
