...
struct data_mover : public sc_module {
    ...
    sc_signal< sc_lv<29> > tx_buffer_V1_reg_150;
    sc_signal< sc_lv<13> > tx_final_burst_lengt_fu_132_p3;
    sc_signal< sc_lv<13> > tx_final_burst_lengt_reg_155;
    sc_signal< sc_lv<13> > tx_loop_count_V_fu_141_p3;
    sc_signal< sc_lv<13> > tx_loop_count_V_reg_160;
    sc_signal< sc_lv<8> > grp_tx_loop_fu_80_axis_V_V_TDATA;
    sc_signal< sc_logic > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWVALID;
    sc_signal< sc_lv<32> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWADDR;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWID;
    sc_signal< sc_lv<32> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWLEN;
    sc_signal< sc_lv<3> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWSIZE;
    sc_signal< sc_lv<2> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWBURST;
    sc_signal< sc_lv<2> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWLOCK;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWCACHE;
    sc_signal< sc_lv<3> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWPROT;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWQOS;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWREGION;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_AWUSER;
    sc_signal< sc_logic > grp_tx_loop_fu_80_m_axi_tx_buffer_V_WVALID;
    sc_signal< sc_lv<64> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_WDATA;
    sc_signal< sc_lv<8> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_WSTRB;
    sc_signal< sc_logic > grp_tx_loop_fu_80_m_axi_tx_buffer_V_WLAST;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_WID;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_WUSER;
    sc_signal< sc_logic > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARVALID;
    sc_signal< sc_lv<32> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARADDR;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARID;
    sc_signal< sc_lv<32> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARLEN;
    sc_signal< sc_lv<3> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARSIZE;
    sc_signal< sc_lv<2> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARBURST;
    sc_signal< sc_lv<2> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARLOCK;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARCACHE;
    sc_signal< sc_lv<3> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARPROT;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARQOS;
    sc_signal< sc_lv<4> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARREGION;
    sc_signal< sc_lv<1> > grp_tx_loop_fu_80_m_axi_tx_buffer_V_ARUSER;
    sc_signal< sc_logic > grp_tx_loop_fu_80_m_axi_tx_buffer_V_RREADY;
    sc_signal< sc_logic > grp_tx_loop_fu_80_m_axi_tx_buffer_V_BREADY;
    sc_signal< sc_logic > grp_tx_loop_fu_80_axis_V_V_TVALID;
    sc_signal< sc_logic > grp_tx_loop_fu_80_axis_V_V_TREADY;
    sc_signal< sc_logic > grp_tx_loop_fu_80_ap_done;
    sc_signal< sc_logic > grp_tx_loop_fu_80_ap_start;
    sc_signal< sc_logic > grp_tx_loop_fu_80_ap_ready;
    sc_signal< sc_logic > grp_tx_loop_fu_80_ap_idle;
    sc_signal< sc_logic > grp_tx_loop_fu_80_ap_continue;
    sc_signal< sc_logic > grp_tx_loop_fu_80_ap_start_reg;
    sc_signal< sc_logic > ap_CS_fsm_state2;
    sc_signal< sc_logic > ap_sync_grp_tx_loop_fu_80_ap_ready;
    sc_signal< sc_logic > ap_sync_grp_tx_loop_fu_80_ap_done;
    sc_signal< bool > ap_block_state2_on_subcall_done;
    sc_signal< sc_logic > ap_sync_reg_grp_tx_loop_fu_80_ap_ready;
    sc_signal< sc_logic > ap_sync_reg_grp_tx_loop_fu_80_ap_done;
    sc_signal< sc_lv<12> > r_V_fu_102_p1;
    sc_signal< sc_lv<13> > tmp_4_i_fu_112_p4;
    sc_signal< sc_lv<1> > tmp_i_fu_106_p2;
    sc_signal< sc_lv<13> > tmp_6_i_cast_fu_122_p1;
    sc_signal< sc_lv<13> > tmp_9_i_fu_126_p2;
    ...
    void thread_ap_sync_grp_tx_loop_fu_80_ap_done();
    void thread_ap_sync_grp_tx_loop_fu_80_ap_ready();
    ...
    void thread_grp_tx_loop_fu_80_ap_continue();
    void thread_grp_tx_loop_fu_80_ap_start();
    void thread_grp_tx_loop_fu_80_axis_V_V_TREADY();
    void thread_r_V_fu_102_p1();
    void thread_tmp_4_i_fu_112_p4();
    void thread_tmp_6_i_cast_fu_122_p1();
    void thread_tmp_9_i_fu_126_p2();
    void thread_tmp_i_fu_106_p2();
    void thread_tx_final_burst_lengt_fu_132_p3();
    void thread_tx_loop_count_V_fu_141_p3();
