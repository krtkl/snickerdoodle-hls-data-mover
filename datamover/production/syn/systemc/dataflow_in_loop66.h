...
#ifndef _dataflow_in_loop66_HH_
#define _dataflow_in_loop66_HH_
...
#include "dataflow_in_loop6bkb.h"
#include "fifo_w12_d2_A.h"

namespace ap_rtl {

struct dataflow_in_loop66 : public sc_module {
    ...
    // Module declarations
    dataflow_in_loop66(sc_module_name name);
    SC_HAS_PROCESS(dataflow_in_loop66);

    ~dataflow_in_loop66();

    sc_trace_file* mVcdFile;

    dataflow_in_loop6bkb* cache_V_U;
    read_burst* read_burst_U0;
    tx_axis_words* tx_axis_words_U0;
    fifo_w12_d2_A* data_length_V_U;
    ...
    sc_signal< sc_lv<12> > read_burst_U0_ap_return;
    ...
    sc_signal< sc_lv<16> > tx_axis_words_U0_axis_V_V_TDATA;
    ...
    sc_signal< sc_lv<12> > data_length_V_dout;
